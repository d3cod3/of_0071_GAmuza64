...
USER_CFLAGS += -I src/ofxCvKalman/src
USER_CFLAGS += -I src/ofxDelaunay/src
USER_CFLAGS += -I src/ofxDelaunay/libs/Delaunay
...
USER_CFLAGS += -I src/ofxTextSuite/src
USER_CFLAGS += -I src/ofxTimeline/src
USER_CFLAGS += -I src/ofxTween/src
USER_CFLAGS += -I src/ofxTween/src/Easings
USER_CFLAGS += -I src/ofxTrueTypeFontUC/src
USER_CFLAGS += -I src/ofxVectorField/src
