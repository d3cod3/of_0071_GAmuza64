    ...
    if(isOniConnected){
       ...
       /* hardware.update();
        ...
        if(useIR){
            ...
            camTexture = recordImageIR.getTextureRef();
        }else{
            recordImage.update();
            camTexture = recordImage.getTextureRef();
        }
