...
class openniTracking: public ofBaseApp, public ofxCvBlobListener{
	...
	public:
			...
			ofxCvKalman				*kBlobInfoX[MAX_NUM_CONTOURS_TO_FIND];
			ofxCvKalman				*kBlobInfoY[MAX_NUM_CONTOURS_TO_FIND];
			ofxCvKalman				*kBlobInfoAngle[MAX_NUM_CONTOURS_TO_FIND];
			ofxCvKalman				*kBlobInfoW[MAX_NUM_CONTOURS_TO_FIND];
			ofxCvKalman				*kBlobInfoH[MAX_NUM_CONTOURS_TO_FIND];
